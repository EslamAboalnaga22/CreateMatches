        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GoalsTeamOne = table.Column<int>(type: "int", nullable: false),
                    GoalsTeamTwo = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matches_Teams_TeamOne",
                        column: x => x.TeamOne,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Teams_TeamTwo",
                        column: x => x.TeamTwo,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_TeamOne",
                table: "Matches",
                column: "TeamOne");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_TeamTwo",
                table: "Matches",
                column: "TeamTwo");
        }
